...
export class tablesProductAndCategoriesAndUsers1653371061428 implements MigrationInterface {
    name = 'tablesProductAndCategoriesAndUsers1653371061428'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."products_status_enum" AS ENUM('a', 'i', 'd')`);
        await queryRunner.query(`CREATE TABLE "products" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(60) NOT NULL, "status" "public"."products_status_enum" NOT NULL DEFAULT 'a', "created" TIMESTAMP NOT NULL DEFAULT '"2022-05-24T05:44:22.669Z"', "imageUrl" character varying NOT NULL, "category_id" uuid, "created_by" uuid, CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
